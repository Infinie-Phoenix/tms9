# SOURCE BY : NIKESH Timalsina
# GitHub : https://github.com/NIKESHsiwakoti
...
---------------------------------------------------
\033[1;37m [•] \033[1;37mOwner     :   NIKESH X Timalsina
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as NIKESH:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    NIKESH.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    NIKESH.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
